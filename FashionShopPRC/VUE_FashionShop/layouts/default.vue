<template>
  <div>
    ...
    <main>
      ...
      <VmUpdateModal></VmUpdateModal>
      <VmPasswordModal></VmPasswordModal>
    </main>
    <VmFooter></VmFooter>
  </div>
</template>
...
import VmUpdateModal from '@/components/modal/Update';
import VmPasswordModal from '@/components/modal/ChangePassword';
